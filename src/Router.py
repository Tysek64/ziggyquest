...
class Router(NetDevice):
    ...
    def process_packet(self, packet: Packet):
        ...
        if packet.payload is not None and packet.payload[0] == Command.NO_REMAIN:
            ...
            if self.current_move[0] is not None and self.current_move[1] is not None and sum(self.finished_turn) == len(self.finished_turn):
            ...
            if self.current_move[0] is None:
                ...
                packet = Packet.generate_packet(self.current_team, self.current_move[0])
